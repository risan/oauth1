...
class UriParserTest extends TestCase
{
    ...
    #[Test]
    public function it_implements_uri_parser_interface()
    {
        $this->assertInstanceOf(UriParserInterface::class, $this->uriParser);
    }

    #[Test]
    public function it_can_parse_to_psr_uri()
    {
    ...
    #[Test]
    public function it_throws_invalid_argument_exception_when_converting_invalid_type()
    {
        // Boolean.
    ...
    #[Test]
    public function it_can_check_if_uri_is_absolute()
    {
    ...
    #[Test]
    public function it_can_check_if_uri_is_not_absolute()
    {
    ...
    #[Test]
    public function it_can_check_if_scheme_is_missing()
    {
    ...
    #[Test]
    public function it_can_check_if_scheme_is_not_missing()
    {
    ...
    #[Test]
    public function it_can_be_built_from_parts()
    {
    ...
    #[Test]
    public function it_can_resolve_relative_uri()
    {
    ...
    #[Test]
    public function it_can_resolve_absolute_uri()
    {
        $baseUri = $this->uriParser->toPsrUri('http://example.com');
    ...
    #[Test]
    public function it_can_append_query_parameters()
    {
